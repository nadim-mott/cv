    ...
    \section{Experience}
    \headingBf[\icon{torontoClimateObservatory.jpeg} ]{Toronto Climate Observatory}{May 2024 -- Present}
    ...
    \end{resume_list}
    \headingBf[\icon{uoft.png} ]{Committee on the Environment, Climate Change, and Sustainability}{May 2025 -- Present}
    \headingIt{Research Assistant}{University of Toronto | Toronto, ON}
    \begin{resume_list}
    ...
    \end{resume_list}
    \headingBf[\icon{unige.jpg} ]{University of Geneva / Manufacture Thinking}{May 2025 -- Present}
